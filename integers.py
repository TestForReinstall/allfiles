...
# что бы ипользовать decimal, нужно его импортировать
...
15/3 # деление 5,0
15 // 3# деление 5
5 % 2 # оствток от деление 1
2**3 # возведение в степень 8
25**0,5 # нахождение кв корня числа 5

# модуль числа- из отрицательного числа получаем положительное
print(abs(-5)) # 5
print(abs(-0.1)) # 0.1
print(abs (10)) # 10
...
print(round(10.007852,4)) # 10.0008
...
#2. находит оствток от депения на 3 число

print(pow(2,3)) # 2**3 = 8
print(pow(2,3,4)) # 2**3%4 = 0

# divmod- функция которая возвращает 2 числа, где 1 целая чвсть от деления, 2- остаток от деления
